/**
 * 네이버 금융 재무제표 스크래퍼 테스트
 */

import { scrapeFinancialData } from '../lib/scraper/naver-stock'

async function testNaverFinancials() {
  console.log('========================================')
  console.log('네이버 금융 재무제표 스크래퍼 테스트')
  console.log('========================================\n')
  ...
  for (const { code, name } of testCodes) {
    ...
    const financials = await scrapeFinancialData(code)
